            ...
            return _vm._l(data, function(tr, indextr) {
              return _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("vs-td", { attrs: { data: data[indextr].phone } }, [
                    _vm._v(_vm._s(data[indextr].phone))
                  ]),
                  _vm._v(" "),
                  _c("vs-td", { attrs: { data: data[indextr].doctor_id } }, [
                    _vm._v(_vm._s(data[indextr].doctor_id))
                  ]),
                  _vm._v(" "),
                  _c("vs-td", { attrs: { data: data[indextr].status } }, [
