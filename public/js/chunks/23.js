...
var ItemListView = function ItemListView() {
  return __webpack_require__.e(/*! import() */ 21).then(__webpack_require__.bind(null, /*! ./ItemListView.vue */ "./resources/js/src/views/pages/ItemListView.vue"));
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      this.nuevaRecetaData.medicamentos.foreach(function (el) {
        console.log(el.img);
      });
    },
