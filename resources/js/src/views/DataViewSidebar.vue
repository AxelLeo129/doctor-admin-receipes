                            ...
                            <vs-table :data="medicines" class="responsive">
                                ...
                                <template slot-scope="{data}">
                                    <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                                        ...
                                        <vs-td :data="data[indextr].price" style="white-space: nowrap;">Q
                ...
                <div class="vx-col w-full sm:w-1/4 lg:w-1/4 mb-base">
                    <vx-card>
                        ...
                        <div class="vx-row">
                            ...
                            <vs-button class="mt-5" @click="popupActive2=false, notificacion1()" color="primary"
                                type="filled" v-if="tipe == 1 && switch1 == '2'" :disabled="total <= 0">Realizar el
                                Pedido</vs-button>
                            <vs-button class="mt-5" @click="popupActive2=false, notificacion()" color="primary"
                                v-if="tipe == 2 && switch1 == '2'" type="filled" :disabled="total <= 0">Realizar el
                                Pedido</vs-button>
                        </div>
                    </vx-card>
                </div>
