...
<template>
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="products">
        ...
        <div class="flex flex-wrap-reverse items-center data-list-btn-container">
          ...
          <vs-dropdown vs-trigger-click class="dd-actions cursor-pointer mr-4 mb-4">
            ...
            <vs-dropdown-menu>
              ...
              <vs-dropdown-item>
                <span class="flex items-center">
                  <feather-icon icon="MessageCircleIcon" svgClasses="h-4 w-4" class="mr-2" />
              ...
              <vs-dropdown-item>
                <span class="flex items-center">
                  <feather-icon icon="CalendarIcon" svgClasses="h-4 w-4" class="mr-2" />
          ...
          <div class="btn-add-new p-3 mb-4 mr-4 rounded-lg cursor-pointer flex items-center justify-center text-lg font-medium text-base text-primary border border-solid border-primary" @click="addNewData">
              <feather-icon icon="UserPlusIcon" svgClasses="h-4 w-4" />
              <span class="ml-2 text-base text-primary">Nuevo Cliente</span>
          </div>
        </div>
      ...
      <template slot="thead">
        <vs-th sort-key="name">Paciente/Cliente</vs-th>
          ...
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td class="whitespace-no-wrap">
                <feather-icon icon="PhoneOutgoingIcon" svgClasses="w-5 h-5 hover:text-primary stroke-current" @click.stop="editData(tr)" />
