            ...
            <div class="algolia-header mb-4">
                <div class="flex md:items-end items-center justify-between flex-wrap">
                    ...
                    <div class="flex justify-between items-end flex-grow">
                        <!-- Stats -->
                        <ais-stats>
                            <p class="font-semibold md:block hidden" v-text="numberData + ' resultados encontrados'">
                            </p>
                        </ais-stats>
                        <div align="right">
                            <label>Medicamentos agregados:</label>
                            <feather-icon icon="FileTextIcon" class="cursor-pointer mt-1 sm:mr-6 mr-2"
                                :badge="mediNum" />
                        </div>
                            ...
                            <div slot-scope="{
                              ...
                              isFromSearch
                                ...
                                <ul>
                                    ...
                                    <li @click="filterMar = 0"
                                        class="mb-2 flex cursor-pointer items-center justify-between">Todos</li>
                                    <li v-for="item in marcas" :key="item.value"
                                        class="mb-2 flex items-center cursor-pointer justify-between"
                                        @click="filterMar = item.value">{{item.label}}</li>
                                </ul>
                            </div>
                        </ais-refinement-list>
                        <vs-divider />
                        ...
                        <div slot-scope="{ currentRefinement, isSearchStalled, refine }">
                            <div class="relative mb-8">
                                ...
                                <vs-input class="w-full vs-input-shadow-drop vs-input-no-border d-theme-input-dark-bg"
                                    placeholder="Ingrese su búsqueda" v-model="buscar" @input="refine($event)"
                    ...
                    <ais-hits>
                        <div>
                            <template v-if="currentItemView == 'item-grid-view'">
                                <div class="vx-row">
                                    <div class="vx-col w-full sm:w-1/3 lg:w-1/3 mb-base" v-for="item in searchMedicina"
                                        :key="item.id">
                                        <vx-card>
                                            <div slot="no-body">
                                                <div align="center">
                                                    <img :src="'https://pharmazone.app/images/productos/' + item.img_url"
                                                        alt="content-img"
        ...
        computed: {
            ...
            searchMedicina: function () {
                return this.medicamentosList.filter(medicina => {
                    ...
                    else if (this.marcasId.includes(this.filterMar))
                        return (
