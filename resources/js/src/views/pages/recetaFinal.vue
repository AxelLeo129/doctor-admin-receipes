    ...
    <div id="invoice-page">
        ...
        <div class="flex flex-wrap items-center justify-between">
          ...
          <div class="flex items-center">
            <vs-button class="mb-base mr-3" type="border" icon-pack="feather" icon="icon icon-download">Descargar</vs-button>
            <vs-button class="mb-base mr-3" icon-pack="feather" icon="icon icon-file" @click="printInvoice">Imprimir</vs-button>
            <vs-button class="mb-base mr-3" color="warning" icon-pack="feather" icon="icon icon-check">Finalizar</vs-button>
          </div>
        </div>
