        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 mb-base">
                <a href="listadoProductos">
                    <statistics-card-line icon="ListIcon" statistic="Medicamentos"
                        statisticTitle="Listado de Medicamentos." :chartData="ordersRecevied.series" color="warning"
                        ...
                        <vs-table pagination max-items="10" search :data="medicamentos">
                            ...
                            <template slot-scope="{data}">
                                <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                                    ...
                                    <vs-td>
                                        <span>
                                            <vs-button color="warning" type="filled" size="small" @click="edit(tr.id)">
                                                Editar</vs-button>
                                            <vs-button color="danger" type="filled" size="small"
                                                @click="popupActive3=true, iden=tr.id">Eliminar</vs-button>
                                        </span>
                                    </vs-td>
                                </vs-tr>
                            </template>
